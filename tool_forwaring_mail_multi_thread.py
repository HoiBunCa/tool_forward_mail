...
def process_security_email(browser, email_protect_text):
    ...
    WebDriverWait(browser, 50).until(EC.element_to_be_clickable((By.ID, "idDiv_SAOTCS_Proofs"))).click()
...
def add_mail_protect(browser, email_protect_text):
    WebDriverWait(browser, 50).until(EC.element_to_be_clickable((By.ID, "EmailAddress"))).send_keys(email_protect_text)
        ...
        try:
            ...
            try:
                ...
                if "Unable to load these settings. Please try again later" in browser.page_source:
                    ...
                    WebDriverWait(browser, 50).until(EC.element_to_be_clickable((By.ID, "DisplayPhoneNumber"))).send_keys(phone_num_th23)  # nhap sdt
                    WebDriverWait(browser, 50).until(EC.element_to_be_clickable((By.ID, "iBtn_action"))).click()
